    ...
    AmCharts.ready(function () {
        ...
        function frmt(x) {
            ...
            var r = "<table>" +
                ...
                "</td></tr>" +
                '<tr><th>Bet:</th><td>' + (entry.bet/Math.pow(10,8)).toFixed() + ' NXT</td></tr>' +
                ...
                '<tr><th>Bonus: </th><td>' + (entry.bonus ? (entry.bonus/Math.pow(10,8)).toFixed(4) : 0) + ' bits</td></tr>' +
                "<tr><th>Profit:</th><td><b>" + (profit/Math.pow(10,8)).toFixed(4) + " bits</b></td></tr>" +
                '</table>';
            return r;
